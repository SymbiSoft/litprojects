...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Il server utilizzato sta utilizzando PHP versione %s ma WordPress richiede almeno la versione 4.3'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'\'installazione PHP appare mancante dell\'estensione MySQL che è necessario per utilizzare WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>ERRORE</strong>: il <code>$table_prefix</code> in <code>wp-config.php</code> può contenere solo numeri, lettere e carattere di sottolineatura.'/*/WP_I18N_BAD_PREFIX*/);
