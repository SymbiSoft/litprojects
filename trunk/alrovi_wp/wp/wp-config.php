...
define('DB_NAME', 'alrovi_db');

/** Nome utente database MySQL */
define('DB_USER', 'alrovi_db');

/** Password database MySQL */
define('DB_PASSWORD', 'rr00vvii');
 ...
 * E' possibile generarle utilizzando il link {@link http://api.wordpress.org/secret-key/1.1/ WordPress.org secret-key service}
 *
 * @since 2.6.0
 */
